...
#pragma once
#include "D3DUtil.h"
#define  PARTICLE_NUMBER  2000   //雪花粒子数量，显卡不好、运行起来卡的童鞋请取小一点。
#define  SNOW_SYSTEM_LENGTH_X	10000   //雪花飞扬区域的长度
#define  SNOW_SYSTEM_WIDTH_Z		10000   //雪花飞扬区域的宽度
#define  SNOW_SYSTEM_HEIGHT_Y     10000   //雪花飞扬区域的高度
